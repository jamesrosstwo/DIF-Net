...
for file in all_names:
    ...
    sdf_dataset = dataset.PointCloudMulti(root_dir=[os.path.join(meta_params['point_cloud_path'], file + '.mat')],
                                          max_num_instances=-1, **meta_params)
    dataloader = DataLoader(sdf_dataset, shuffle=True, collate_fn=sdf_dataset.collate_fn, batch_size=1, pin_memory=True,
